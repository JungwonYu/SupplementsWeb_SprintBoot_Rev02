	...
	<div class="container px-5">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
				...
				<li class="nav-item"><a class="nav-link me-lg-3 active" href="bbs2">방명록</a></li>
				<li class="nav-item"><a class="nav-link me-lg-3" href="bbs">게시판</a></li>
...
<!-- /Navigation-->
<div class="container">
	<h1 class="card-title text-center my-5 fw-bold fs-3">방명록</h1>
	<hr class="mt-2 mb-4">
	<div class="row">
		<form method="post" action="writeAction2" enctype="multipart/form-data">
			<table class="table table-striped">
				<thead>
				<tr>
					<th class="card-title" colspan="2">방명록 글쓰기</th>
				</tr>
				</thead>
				<tbody>
				<tr>
